...
# Named _DEST_ARN, not _DEST: this is a bare ARN string, and the module-level
# _DEST above is a DestinationRef. Reusing the name rebound the global that
# make_rule() reads, silently giving every rule in this file a str destination.

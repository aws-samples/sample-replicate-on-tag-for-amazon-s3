...
Adding or widening a tag-scoped rule does not replicate objects that were tagged before the change. [Backfill procedure](docs/backfill.md) has the Athena query and Batch Operations recipe for a manual catch-up.
